...
@dataclass
class PantagruelTextClassificationConfig(FairseqDataclass):
...
@register_model(
    "pantagruel_text_classification", dataclass=PantagruelTextClassificationConfig
)
class PantagruelTextClassificationModel(BaseFairseqModel):
    def __init__(self, cfg: PantagruelTextClassificationConfig):
        super().__init__()
        self.cfg = cfg
    ...
    @classmethod
    def build_model(cls, cfg: PantagruelTextClassificationConfig, task=None):
